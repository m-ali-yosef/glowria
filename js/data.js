...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt: "A quick guide for oily, dry, combination, and sensitive skin so you can shop with confidence.",
  ...
  },
  {
    ...
    excerpt: "UV rays penetrate through windows and clouds. Here is how to smartly protect your skin.",
...
const TESTIMONIALS = [
  {
    ...
    city: "Cairo",
    text: "My skin became much more balanced after two weeks on the Glow Repair serum. The texture is lightweight and absorbs instantly.",
    rating: 5,
  },
  {
    name: "Lama Hassan",
    city: "Alexandria",
    text: "Glow Cleanse saved my sensitive skin. Finally a product that cleanses without tightness or redness.",
    rating: 5,
  },
  {
    name: "Hind Al-Qahtani",
    city: "Giza",
    text: "I ordered the complete Glow Routine Set. The packaging is elegant and the results are amazing.",
    rating: 5,
  }
];